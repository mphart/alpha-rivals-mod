...
print(bridge.send("set_joy_override 0 1"))
print(bridge.send("set_joy_override 1 1"))
print(bridge.send("set_joy_override 2 1"))
print(bridge.send("set_joy_override 3 1"))

print(bridge.set_joy_button(0, "a", True))
print(bridge.set_joy_button(1, "a", True))
print(bridge.set_joy_button(2, "a", True))
print(bridge.set_joy_button(3, "a", True))

print(bridge.release_joy(0))
